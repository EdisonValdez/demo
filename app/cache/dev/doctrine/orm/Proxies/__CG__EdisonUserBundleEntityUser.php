...
namespace Proxies\__CG__\Edison\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Edison\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'Edison\\UserBundle\\Entity\\User' . "\0" . 'isActive', 'demos');
        }
    ...
    public function getDemos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDemos', array());

        return parent::getDemos();
    }
