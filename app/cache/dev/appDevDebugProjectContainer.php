...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'demo_report_manager' => 'getDemoReportManagerService',
            ...
            'twig.demo_extension' => 'getTwig_DemoExtensionService',
    ...
    {
        $this->services['assetic.filter.uglifycss'] = $instance = new \Assetic\Filter\UglifyCssFilter(($this->targetDirs[2].'/../node_modules/.bin/uglifycss'), 'C:\\Program Files\\nodejs\\\\node.EXE');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'uglifycss' => 'assetic.filter.uglifycss'));
    }
    ...
    /**
     * Gets the 'demo_report_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Edison\DemoBundle\Reporting\DemoReportManager A Edison\DemoBundle\Reporting\DemoReportManager instance.
     */
    protected function getDemoReportManagerService()
    {
        return $this->services['demo_report_manager'] = new \Edison\DemoBundle\Reporting\DemoReportManager($this->get('doctrine.orm.default_entity_manager'), $this->get('router'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'edison_demo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $c, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Edison\\DemoBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Edison\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Edison\\DemoBundle\\Entity');
        $c->addDriver($b, 'Edison\\UserBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('DemoBundle' => 'Edison\\DemoBundle\\Entity', 'UserBundle' => 'Edison\\UserBundle\\Entity'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Edison\UserBundle\Doctrine\UserListener A Edison\UserBundle\Doctrine\UserListener instance.
     */
    protected function getDoctrine_UserListenerService()
    {
        return $this->services['doctrine.user_listener'] = new \Edison\UserBundle\Doctrine\UserListener($this->get('security.encoder_factory'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_791fc95fb8477184d2d6acafe16fe7683d86b87c7910dc14ef8961c1735bed13');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Edison\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 13))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.demo_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        $p = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'Order 1138', 'demo_secured_area', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $q = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $o, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($o, 'demo'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        ...
        $r->setProviderKey('demo_secured_area');
        ...
        $t = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $o, 'demo_secured_area', $r, $s, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $t->setRememberMeServices($p);

        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'demo_secured_area', $a, $d), 2 => $q, 3 => $t, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $p, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55417cb94f510', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker'), 'demo_secured_area', $h, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 7 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $h, $n, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $o, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $o, 'login', false), NULL, NULL, $a));
    }
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), 'VI-return-of-jedi', '%s?v=%s'), array());
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => '::form_theme.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array()));

        $instance->addExtension($this->get('twig.demo_extension'));
    ...
    /**
     * Gets the 'twig.demo_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Edison\DemoBundle\Twig\DemoExtension A Edison\DemoBundle\Twig\DemoExtension instance.
     */
    protected function getTwig_DemoExtensionService()
    {
        return $this->services['twig.demo_extension'] = new \Edison\DemoBundle\Twig\DemoExtension();
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Edison\\DemoBundle/Resources/views'), 'Demo');
        $instance->addPath(($this->targetDirs[3].'\\src\\Edison\\UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('335390b1b730e36972c8e3cccb080c4e3b0cc1df');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.our_database_users'), $a, 'demo_secured_area', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'Order 1138', 'demo_secured_area'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55417cb94f510')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(0 => 'ROLE_BLOG_CREATE', 1 => 'ROLE_EVENT_CREATE'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_EVENT_CREATE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DemoBundle' => 'Edison\\DemoBundle\\DemoBundle',
                'UserBundle' => 'Edison\\UserBundle\\UserBundle',
            ...
            'locale' => 'en',
            'secret' => '335390b1b730e36972c8e3cccb080c4e3b0cc1df',
            'our_assets_version' => 'VI-return-of-jedi',
            ...
            'kernel.secret' => '335390b1b730e36972c8e3cccb080c4e3b0cc1df',
